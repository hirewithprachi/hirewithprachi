...
(
    'Welcome Email',
    'user_registered',
    'Hello {{user_name}},\n\nWelcome to Hire with Prachi! We are thrilled to have you join our community of HR professionals.\n\nHere is what you can do now:\n• Explore our AI-powered HR tools\n• Access professional templates\n• Connect with HR experts\n• Get personalized career guidance\n\nStart your journey: {{dashboard_url}}\n\nBest regards,\nThe Hire with Prachi Team\n\n---\nThis email was sent to {{user_email}}. If you did not sign up, please ignore this email.',
