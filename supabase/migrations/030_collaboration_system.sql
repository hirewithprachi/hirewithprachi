...
-- Support for multi-user resume editing with real-time features
...
CREATE INDEX idx_collaboration_changes_resume_id ON collaboration_changes(resume_id);
CREATE INDEX idx_collaboration_changes_timestamp ON collaboration_changes(timestamp);
CREATE INDEX idx_collaboration_changes_user_id ON collaboration_changes(user_id);
CREATE INDEX idx_collaboration_changes_change_id ON collaboration_changes(change_id);

-- Comments
CREATE INDEX idx_collaboration_comments_resume_id ON collaboration_comments(resume_id);
CREATE INDEX idx_collaboration_comments_field_path ON collaboration_comments(field_path);
CREATE INDEX idx_collaboration_comments_user_id ON collaboration_comments(user_id);
CREATE INDEX idx_collaboration_comments_created_at ON collaboration_comments(created_at);
CREATE INDEX idx_collaboration_comments_resolved ON collaboration_comments(resolved);

-- Permissions
CREATE INDEX idx_collaboration_permissions_resume_id ON collaboration_permissions(resume_id);
CREATE INDEX idx_collaboration_permissions_user_id ON collaboration_permissions(user_id);
CREATE INDEX idx_collaboration_permissions_active ON collaboration_permissions(is_active);

-- Invitations
CREATE INDEX idx_collaboration_invitations_target_email ON collaboration_invitations(target_email);
...
-- Sessions
CREATE INDEX idx_collaboration_sessions_resume_id ON collaboration_sessions(resume_id);
...
CREATE INDEX idx_collaboration_sessions_last_seen ON collaboration_sessions(last_seen);

-- Activity
CREATE INDEX idx_collaboration_activity_resume_id ON collaboration_activity(resume_id);
CREATE INDEX idx_collaboration_activity_created_at ON collaboration_activity(created_at);

-- Snapshots
CREATE INDEX idx_collaboration_snapshots_resume_id ON collaboration_snapshots(resume_id);
CREATE INDEX idx_collaboration_snapshots_version ON collaboration_snapshots(version_number);
...
-- =============================================
-- Scheduled Cleanup (Set up via pg_cron if available)
-- =============================================
...
-- =============================================
-- Initial Data and Example Usage
-- =============================================

-- Example: Grant comment permission to a user
-- INSERT INTO collaboration_permissions (resume_id, user_id, permission, granted_by)
-- VALUES ('resume-uuid', 'user-uuid', 'comment', 'owner-uuid');

-- Example: Add a comment
-- INSERT INTO collaboration_comments (id, resume_id, user_id, user_profile, content, field_path, type)
-- VALUES ('comment_123', 'resume-uuid', 'user-uuid', '{"name": "John Doe", "avatar": "url"}', 'Great experience description!', 'experience[0].bullets[1]', 'comment');

-- Example: Track a change
-- INSERT INTO collaboration_changes (resume_id, change_id, user_id, change_type, field_path, old_value, new_value)
-- VALUES ('resume-uuid', 'change_123', 'user-uuid', 'update', 'experience[0].role', '"Software Engineer"', '"Senior Software Engineer"');

-- Verify deployment
SELECT 'Collaboration System Deployed Successfully' as status,
