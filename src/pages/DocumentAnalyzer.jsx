...
export default function DocumentAnalyzer() {
  ...
  const handleDownload = async () => {
    ...
    try {
      const filename = await downloadCalculatorPDF('document-analyzer', result, companyInfo);
      setDownloaded(true);
...
OVERALL SCORE: ${result.analysis.overallScore}/100

ANALYSIS BREAKDOWN:
- Compliance Score: ${result.analysis.compliance}%
- Clarity Score: ${result.analysis.clarity}%
- Completeness Score: ${result.analysis.completeness}%
- Legal Risk Level: ${result.analysis.legalRisk}%

SUGGESTIONS FOR IMPROVEMENT:
${result.analysis.suggestions.map(s => `• ${s}`).join('\n')}

MISSING ELEMENTS:
${result.analysis.missingElements.map(e => `• ${e}`).join('\n')}
...
AI-Powered Document Analysis
    `;
      ...
      a.href = url;
      a.download = `document-analysis-${result.documentType.toLowerCase().replace(/\s+/g, '-')}.txt`;
      a.click();
