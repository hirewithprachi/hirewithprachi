        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-8 md:gap-12 lg:gap-20 px-4">
          ...
          <div className="flex flex-col gap-4 md:gap-6 items-center md:items-start w-full md:w-1/2">
            <div className="flex flex-row gap-4 md:gap-6 items-center">
              <ResponsiveImage src="/assets/images/about-img-1.jpg" alt="HR Consultant Badge" className="w-32 h-32 md:w-40 md:h-40 rounded-full object-contain border-6 md:border-8 border-[#d4ff3f] bg-[#d4ff3f]" />
<ResponsiveImage src="/assets/images/about-img-2.jpg" alt="Virtual HR Services" className="w-44 h-56 md:w-56 md:h-72 rounded-2xl md:rounded-3xl object-cover shadow-xl" />
            </div>
            <div className="flex flex-row gap-4 md:gap-6 mt-2">
              <ResponsiveImage src="/assets/images/about-img-3.jpg" alt="Remote HR Support" className="w-32 h-24 md:w-40 md:h-32 rounded-xl md:rounded-2xl object-cover shadow-lg" />
<ResponsiveImage src="/assets/images/about-img-1.jpg" alt="HR Consulting" className="w-32 h-24 md:w-40 md:h-32 rounded-xl md:rounded-2xl object-cover shadow-lg" />
